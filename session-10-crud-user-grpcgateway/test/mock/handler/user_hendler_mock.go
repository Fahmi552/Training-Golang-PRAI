...
func (m *MockIUserHandler) GetUserEmail(c *gin.Context) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "GetUserEmail", c)
}

// GetUserEmail indicates an expected call of GetUserEmail.
func (mr *MockIUserHandlerMockRecorder) GetUserEmail(c interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserEmail", reflect.TypeOf((*MockIUserHandler)(nil).GetUserEmail), c)
}
