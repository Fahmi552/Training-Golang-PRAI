...
type TransactionServiceClient interface {
	CreateTransaction(ctx context.Context, in *CreateTransactionRequest, opts ...grpc.CallOption) (*MutationResponse, error)
}
...
func (c *transactionServiceClient) CreateTransaction(ctx context.Context, in *CreateTransactionRequest, opts ...grpc.CallOption) (*MutationResponse, error) {
...
type TransactionServiceServer interface {
	CreateTransaction(context.Context, *CreateTransactionRequest) (*MutationResponse, error)
...
func (UnimplementedTransactionServiceServer) CreateTransaction(context.Context, *CreateTransactionRequest) (*MutationResponse, error) {
...
var TransactionService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/transaction_proto.proto",
}
