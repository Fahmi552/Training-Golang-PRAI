...
import (
	"Training/session-11-crud-user-grpcgateway-redis/handler"
	"Training/session-11-crud-user-grpcgateway-redis/middleware"
...
func SetupRouter(r *gin.Engine, userHandler handler.IUserHandler) {
	...
	// Rute untuk mendapatkan pengguna berdasarkan ID
	usersPublicEndpoint.GET("/email/:email", userHandler.GetUserEmail)
